...
export const CURRENT_APP_VERSION = 'v1.31.10'
...
export const notSelfHibiApi = `${BASE_API_URL}`.includes(process.env.VUE_APP_PXVEAPI_MAIN) || !/cocomi\.eu\.org|pixiv\.pictures|169889\.xyz|pxve\.cc|hibiapi\.getloli\.com|api\.obfs\.dev/.test(BASE_API_URL)
export const PIXIV_NEXT_URL = process.env.VUE_APP_PXVEAPI_MAIN || 'https://api.cocomi.eu.org'
