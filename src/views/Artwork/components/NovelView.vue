  ...
  computed: {
    ...
    novelText() {
      return this.textObj.text
        ...
        ?.replace(/\[\[rb:([^>\s[\]]+) *> *([^>\s[\]]+)\]\]/g, '<ruby>$1<rt>$2</rt></ruby>')
